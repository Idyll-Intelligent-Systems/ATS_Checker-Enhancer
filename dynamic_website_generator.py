...
try:
    ...
    # Fallback if utils not available in standalone usage
    def log_function(_type: str = "DEBUG", _remark: str | None = "SUCCESS"):
        def _noop(fn):
            return fn
        return _noop
...
class DynamicWebsiteGenerator:
    ...
    @log_function("INFO", "EXTRACT_RESUME_DATA_OK")
    ...
    @log_function("DEBUG", "EXTRACT_WITH_PROCESSORS_OK")
    ...
    @log_function("DEBUG", "EXTRACT_BASIC_OK")
    ...
    @log_function("DEBUG", "EXTRACT_TEXT_FROM_FILE_OK")
    ...
    @log_function("DEBUG", "EXTRACT_PDF_TEXT_OK")
    ...
    @log_function("DEBUG", "EXTRACT_DOCX_TEXT_OK")
    ...
    @log_function("DEBUG", "PARSE_RESUME_TEXT_OK")
    ...
    @log_function("DEBUG", "EXTRACT_SECTIONS_OK")
    ...
    @log_function("DEBUG", "DEFAULT_STRUCTURE_OK")
    ...
    @log_function("INFO", "GENERATE_WEBSITE_OK")
    ...
    @log_function("DEBUG", "APPLY_THEME_OK")
    ...
    @log_function("DEBUG", "GENERATE_README_OK")
...
"""
    ...
    @log_function("DEBUG", "GENERATE_DEPLOY_CONFIGS_OK")
...
"""
    ...
    @log_function("INFO", "CREATE_ZIP_OK")
    ...
    @log_function("REMARK", "PREVIEW_WEBSITE_OK")
...
@log_function("INFO", "GENERATOR_CLI_OK")
def main():
    """Main CLI interface"""
